...
export enum GamePhase {
  ...
  // Day 8 Phases
  DAY_8_ART_INTRO = 'DAY_8_ART_INTRO',
  DAY_8_PAINTING = 'DAY_8_PAINTING',
  DAY_8_HORROR_REVEAL = 'DAY_8_HORROR_REVEAL',
  NIGHT_8_LUNCH_WALK = 'NIGHT_8_LUNCH_WALK',
  NIGHT_8_PAINT_DISCOVERY = 'NIGHT_8_PAINT_DISCOVERY',

  // Day 9 Phases
  DAY_9_HALLWAY_BULLY = 'DAY_9_HALLWAY_BULLY',
  DAY_9_GRIM_CLASS_WAIT = 'DAY_9_GRIM_CLASS_WAIT',
  DAY_9_INK_RUN = 'DAY_9_INK_RUN',

  // Day 10 Phases
  DAY_10_GYM_INTRO = 'DAY_10_GYM_INTRO',
  DAY_10_DUNK_TASK = 'DAY_10_DUNK_TASK',
  DAY_10_INJURY = 'DAY_10_INJURY',
  NIGHT_10_NURSE_INTRO = 'NIGHT_10_NURSE_INTRO',
  NIGHT_10_SURVIVAL_QTE = 'NIGHT_10_SURVIVAL_QTE',
  NIGHT_10_INK_CHOICE = 'NIGHT_10_INK_CHOICE',
  NIGHT_10_TRANSFORMATION = 'NIGHT_10_TRANSFORMATION',
